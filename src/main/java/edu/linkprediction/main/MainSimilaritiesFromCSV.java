...
import edu.linkprediction.similarityMetrics.SimilaritiesFromCSV;
...
public class MainSimilaritiesFromCSV {
    ...
    private static void predictByPackage() throws Exception {
        ...
        similarities.add(
                new SimilaritiesFromCSV(Utils.getThresholdsList(3, 0.1, 0.6),
                        "src/main/resources/similarities/subscriberdb-similarities/RevistaKolbe_v1.0.zip-similarities-lexical-null-package.csv"));
