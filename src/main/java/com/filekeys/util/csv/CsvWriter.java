...
public class CsvWriter implements AutoCloseable {
    ...
    /**
     * Creates a {@link com.filekeys.util.csv.CsvWriter CsvWriter} object using a file
    ...
    /**
     * Creates a {@link com.filekeys.util.csv.CsvWriter CsvWriter} object using a Writer
     * to write data to.
     *
     * @param outputStream
    ...
    /**
     * Creates a {@link com.filekeys.util.csv.CsvWriter CsvWriter} object using an
    ...
    public void write(String content, boolean preserveSpaces)
        ...
        if (userSettings.UseTextQualifier && !textQualify &&
            ...
            if (!textQualify && (content.length() > 1)) {
                ...
                if ((lastLetter == Letters.SPACE) ||
                        (lastLetter == Letters.TAB)) {
                    textQualify = true;
                }
            }
        }
